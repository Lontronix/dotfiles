# Generated by Powerlevel10k configuration wizard on 2020-10-11 at 03:21 EDT.
...
() {
  ...
  # - global  `asdf current` sa"ys "set by /home/username/file"
  #
  ...
  # in the current directory, or its parent diretory, or its grandparent directory, anso on.
  #
